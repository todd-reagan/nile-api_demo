...
def lambda_handler(event, context):
    ...
    # Initialize the nileSite class with the API key and tenant ID
    nileSites = nileSite(api_key=api_key, tenant_id=tenant_id)

    try:
        sites = nileSites.get_sites()
